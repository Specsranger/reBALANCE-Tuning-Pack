...
- Chaffee:
  - Increased AOE area radius from 1.5 to 4 for better anti-infantry.
...
- Fixed an issue where Sd.Kfz. 251 Mechanized Grenadier's “Break down” ability didn't require the vehicle to be stationary.
